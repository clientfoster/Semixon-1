...
export const metadata: Metadata = {
  title: 'Sitemap - Semixion',
  description: 'Complete sitemap of Semixion website. Find all our pages, services, industries, and resources.',
  robots: {
    index: true,
    follow: true,
  },
...
const sitemapData = {
  main: [
    { href: '/', label: 'Home', description: 'Semixion homepage with company overview' },
