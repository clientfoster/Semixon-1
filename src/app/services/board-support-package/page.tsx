...
import { ArrowRight, Cpu, HardDrive, FileCode, Settings, Target, TrendingUp, Shield } from 'lucide-react';

const capabilities = [
  {
    title: 'Bootloader Development',
    description: 'Secure and fast system startup solutions',
    icon: HardDrive,
    features: ['U-Boot customization and hardening', 'Proprietary bootloader development', 'Secure boot implementation', 'Fast boot optimization']
  },
  {
    title: 'Kernel Porting & Hardening',
    description: 'OS integration and optimization',
    icon: Cpu,
    features: ['Linux kernel porting', 'Android OS integration', 'RTOS configuration', 'Kernel hardening and optimization']
  },
  {
    title: 'Custom Device Drivers',
    description: 'Reliable peripheral interface drivers',
    icon: Settings,
    features: ['Peripheral driver development', 'Interface protocol implementation', 'Performance optimization', 'Power management integration']
  },
  {
    title: 'Build System Integration',
    description: 'Comprehensive build environment setup',
    icon: FileCode,
    features: ['Yocto Project integration', 'Buildroot configuration', 'Custom build scripts', 'CI/CD pipeline setup']
  }
];
...
const benefits = [
  {
    ...
    description: 'Fully tested and validated BSPs',
    icon: Shield
  },
  {
    title: 'Optimized Performance',
    description: 'Fine-tuned for your specific hardware',
    icon: TrendingUp
  },
  {
...
export default function BoardSupportPackagePage() {
  return (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
                  Bridging
                  <span className="block text-blue-600">Hardware and Software</span>
                </h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <p className="text-slate-600">Tailored BSPs for your specific hardware requirements</p>
                  </div>
                  <div className="flex items-start">
                    <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center mr-4 mt-1">
                      <div className="w-2 h-2 bg-white rounded-full"></div>
                    </div>
                    <p className="text-slate-600">Fully tested and validated for production use</p>
                  </div>
                  <div className="flex items-start">
                    <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center mr-4 mt-1">
                      <div className="w-2 h-2 bg-white rounded-full"></div>
                    </div>
                    <p className="text-slate-600">Complete documentation and build system integration</p>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8">
                  <div className="grid grid-cols-2 gap-6">
                    <div className="text-center">
                      ...
                      <p className="text-slate-600">BSPs Developed</p>
                    </div>
                    <div className="text-center">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
                Why Choose Our
                <span className="block text-blue-600">BSP Development Services</span>
              </h2>
              <p className="text-lg text-slate-600 leading-relaxed max-w-3xl mx-auto">
