...
import { ArrowRight, Shield, Target, Zap, TrendingUp, Cpu, CheckCircle } from 'lucide-react';

const capabilities = [
  {
    title: 'Functional Verification',
    description: 'Comprehensive functional verification of digital and mixed-signal designs',
    icon: Shield,
    features: ['Testbench development', 'Coverage analysis', 'Assertion-based verification', 'Formal verification']
  },
  {
    title: 'Timing Verification',
    description: 'Static and dynamic timing analysis for design closure',
    icon: Target,
    features: ['Static timing analysis', 'Dynamic timing simulation', 'Clock domain crossing', 'Timing closure']
  },
  {
    title: 'Power Verification',
    description: 'Power analysis and optimization for energy-efficient designs',
    icon: Zap,
    features: ['Power estimation', 'Power analysis', 'Low-power design', 'Power optimization']
  },
  {
    title: 'Physical Verification',
    description: 'Layout verification and design rule checking',
    icon: CheckCircle,
    features: ['DRC verification', 'LVS checking', 'Antenna checking', 'ERC verification']
  }
];
...
const benefits = [
  {
    ...
    description: 'Identify and fix design issues before silicon fabrication',
    icon: Shield
  },
  {
    title: 'Cost Reduction',
    description: 'Prevent costly silicon respins with thorough verification',
    icon: Target
  },
  {
    title: 'Quality Assurance',
    description: 'Ensure design meets specifications and quality standards',
    icon: CheckCircle
  }
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
                  Comprehensive
                  <span className="block text-blue-600">Verification Solutions</span>
                </h2>
                <p className="text-lg text-slate-600 leading-relaxed mb-8">
                  Our design verification services cover all aspects of semiconductor design validation, from functional verification to physical verification, ensuring your designs meet the highest quality standards.
                </p>
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <p className="text-slate-600">Advanced verification methodologies and tools</p>
                  </div>
                  <div className="flex items-start">
                    <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center mr-4 mt-1">
                      <div className="w-2 h-2 bg-white rounded-full"></div>
                    </div>
                    <p className="text-slate-600">Comprehensive coverage analysis and metrics</p>
                  </div>
                  <div className="flex items-start">
                    <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center mr-4 mt-1">
                      <div className="w-2 h-2 bg-white rounded-full"></div>
                    </div>
                    <p className="text-slate-600">Formal verification and assertion-based design</p>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8">
                  <div className="grid grid-cols-2 gap-6">
                    <div className="text-center">
                      ...
                      <p className="text-slate-600">Designs Verified</p>
                    </div>
                    <div className="text-center">
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="text-2xl font-bold text-slate-900">90%</h3>
                      <p className="text-slate-600">Faster Verification</p>
                    </div>
                    <div className="text-center">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 leading-relaxed max-w-3xl mx-auto">
                From functional verification to physical verification, we deliver comprehensive design validation solutions that ensure your designs meet the highest quality standards.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
                Why Choose Our
                <span className="block text-blue-600">Verification Services</span>
              </h2>
              <p className="text-lg text-slate-600 leading-relaxed max-w-3xl mx-auto">
                Our proven track record and deep expertise in design verification make us the preferred partner for semiconductor companies worldwide.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-slate-300 mb-12 leading-relaxed max-w-3xl mx-auto">
              Ready to ensure your design quality? Our team of expert engineers is here to help you achieve your verification goals.
            </p>
